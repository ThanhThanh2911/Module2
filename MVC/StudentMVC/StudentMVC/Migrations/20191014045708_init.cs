    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Groups",
                columns: new[] { "GroupId", "Description", "GroupName", "StartDate" },
                values: new object[] { 2, "K An Hai", "C2", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "Groups",
                columns: new[] { "GroupId", "Description", "GroupName", "StartDate" },
                values: new object[] { 3, "Tot", "C3", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
